...
var GoogleVoice = function(credentials){
	/* Google Voice client instance */
	var client = new voice.Client({email: credentials.email, password: credentials.password, 
		tokens: require(credentials.tokens)
	});
